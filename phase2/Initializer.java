...
public class Initializer {
    ...
    public void initialize() {
        ...
        Event christmas = new Event("Christmas", 100, LocalDateTime.parse("2020-11-27T18:00:00"), 1001, 60);
        Event halloween = new Event("Halloween", 101, LocalDateTime.parse("2020-11-28T18:00:00"), 1001, 120);
        Event birthday = new Event("Birthday", 102, LocalDateTime.parse("2020-11-27T19:00:00"),1001,120);
